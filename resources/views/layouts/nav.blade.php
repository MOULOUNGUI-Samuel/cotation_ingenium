<<<<<<< HEAD
<nav class="bg-[#763c26]/70 border-b border-gray-200 px-4 py-2.5 dark:bg-[#763c26]/70 dark:border-gray-400 fixed left-0 right-0 top-0 z-50">
=======
    ...
    <div class="flex flex-wrap justify-between items-center">
      <div class="flex justify-start items-center">
        ...
        <a href="#" class="flex items-center justify-between mr-4">
          <img
<<<<<<< HEAD
            src="images/logo-ingenium-assu.png" class="h-12 me-2 shadow-lg p-2 shadow-gray-100 rounded-lg bg-white"
=======
