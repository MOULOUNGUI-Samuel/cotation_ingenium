        ...
        <form action="{{route('enregistrer_cotation')}}" method="POST" class="space-y-4 md:max-h-auto overflow-y-auto p-4 bg-white/90 rounded-lg" id="multi-step-form" enctype="multipart/form-data">
            ...
            <div id="accordion-nested-collapse" data-accordion="collapse">
                <h2 id="accordion-nested-collapse-heading-1">
                  <button type="button" class="flex items-center justify-between w-full p-5 rounded-t-xl font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 bg-[#763c26]/95 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-[#763c26] gap-3" data-accordion-target="#accordion-nested-collapse-body-1" aria-expanded="false" aria-controls="accordion-nested-collapse-body-1">
