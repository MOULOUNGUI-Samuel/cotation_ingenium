      ...
      >
        ...
        <main>
          <div class="w-full max-w-sm px-4 py-6 space-y-6 bg-white rounded-md dark:bg-darker">
            <h1 class="text-xl font-semibold text-center">Inscription</h1>
              ...
              <div class="flex items-center justify-between">
                ...
                <label class="flex items-center">
                  ...
                  <span class="ml-3 text-sm font-normal text-gray-500 dark:text-gray-400">
                    J'accepte 
                    <a href="#" class="text-sm text-blue-600 hover:underline">les termes et conditions</a>
                  </span>
                </label>
              </div>
              <div>
            ...
            <div class="text-sm text-gray-600 dark:text-gray-400">
                Vous avez déjà un compte ? <a href="{{route('connexion')}}" class="text-blue-600 hover:underline"> Se connecter</a>
            </div>
          </div>
        </main>
      </div>
